...
package org.iplatform.microservices.core.datavec.api.transform.TransformProcess;
...
import org.iplatform.microservices.core.datavec.api.transform.time.StringToTimeTransformEx;
...
@Data
@Slf4j
public class TransformProcessEx extends TransformProcess {

    private TransformProcessEx(TransformProcessEx.Builder builder) {
        super(builder.initialSchema, builder.actionList);
    }

    /**
     * Builder class for constructing a TransformProcessEx
     */
    public static class Builder {
        ...
        public Builder stringToTimeTransform(String column, String format, DateTimeZone dateTimeZone,Locale locale) {
            return transform(new StringToTimeTransformEx(column, format, dateTimeZone,locale));
        }
        ...
        /**
         * Create the TransformProcessEx object
         */
        public TransformProcessEx build() {
            return new TransformProcessEx(this);
        }
