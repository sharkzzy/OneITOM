package org.iplatform.example.service.examples.datavec.debugging;
 ...
 * This can be useful for debugging your TransformProcessEx scripts.
 *
 * @author Alex Black
 */

@Component
public class PrintSchemasAtEachStep implements IExample {
    @Override
    public void run() {
        try{
//Define the Schema and TransformProcessEx as per BasicDataVecExample
