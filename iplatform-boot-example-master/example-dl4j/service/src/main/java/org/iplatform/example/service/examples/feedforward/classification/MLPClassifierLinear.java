package org.iplatform.example.service.examples.feedforward.classification;
...
@Component
public class MLPClassifierLinear implements IExample {
    ...
    public void run() {
        try {
            ...
            //使用测试集进行模型评估
            org.nd4j.evaluation.classification.Evaluation eval = model.evaluate(testIter);
