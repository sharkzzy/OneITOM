...
@Component
public class LogDataExample implements IExample ,Serializable {
    ...
    public void run() {
        try {
            ...
            TransformProcessEx tp = new TransformProcessEx.Builder(schema)
                    ...
                    .stringToTimeTransform("timestamp", "dd/MMM/YYYY:HH:mm:ss Z", DateTimeZone.forOffsetHours(-4),Locale.US)
