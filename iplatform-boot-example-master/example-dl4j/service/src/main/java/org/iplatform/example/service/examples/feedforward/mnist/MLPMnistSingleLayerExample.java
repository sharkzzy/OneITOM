package org.iplatform.example.service.examples.feedforward.mnist;
...
@Component
public class MLPMnistSingleLayerExample implements IExample {
    ...
    public void run() {
        try {
            ...
            log.info("train model begin");
            long s = System.currentTimeMillis();
            for (int i = 0; i < numEpochs; i++) {
                model.fit(mnistTrain);
            }
            long e = System.currentTimeMillis();
            log.info("train model finished (" + String.valueOf((e - s) / 1000) + "s)");
