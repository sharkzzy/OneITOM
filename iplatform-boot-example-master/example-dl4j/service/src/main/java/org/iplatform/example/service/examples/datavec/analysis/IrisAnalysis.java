 ...
 */
@Component
public class IrisAnalysis implements IExample {
    ...
    public void run() {
        try {
            ...
            String directory = new ClassPathResource("IrisData/iris.txt").getFile().getAbsolutePath(); //Normally just define your directory like "file:/..." or "hdfs:/..."
